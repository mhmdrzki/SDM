...
--
-- Host: localhost:3306
-- Generation Time: Mar 20, 2021 at 10:32 AM
...
CREATE TABLE `kabkota` (
  ...
  `nama_kabkota` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `kabkota` (`id_kabkota`, `id_provinsi`, `nama_kabkota`) VALUES
...
CREATE TABLE `kecamatan` (
  ...
  `nama_kecamatan` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `kecamatan` (`id_kecamatan`, `id_kabkota`, `nama_kecamatan`) VALUES
